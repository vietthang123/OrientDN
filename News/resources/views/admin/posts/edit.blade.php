    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.posts.update", [$post->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('user') ? 'is-invalid' : '' }}" name="user_id" id="user_id" required>
                    @foreach($users as $id => $user)
                        <option value="{{ $id }}" {{ (old('user_id') ? old('user_id') : $post->user->id ?? '') == $id ? 'selected' : '' }}>{{ $user }}</option>
                    @endforeach
                </select>
                @if($errors->has('user'))
            ...
            <div class="form-group">
                ...
                id="slug" onkeyup="ChangeToSlug();" value="{{ old('name', $post->name) }}" required>
                @if($errors->has('name'))
            ...
            <div class="form-group">
              ...
              id="convert_slug" value="{{ old('slug', $post->slug) }}">
              @if($errors->has('slug'))
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('title') ? 'is-invalid' : '' }}" name="title" id="title">{!! old('title', $post->title) !!}</textarea>
                @if($errors->has('title'))
            ...
            <div class="form-group">
              <label class="required" for="image">{{ trans('cruds.post.fields.image') }}</label>
                ...
                name="image" id="exampleInputEmail1"><p></p>
